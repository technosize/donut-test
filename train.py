...
def train(config):
    ...
    # os.environ['MASTER_ADDR'] = 'fe80::30bc:a62a:3162:ceb5'
    # os.environ['MASTER_PORT'] = '9999'
    # torch.distributed.init_process_group(backend='gloo',rank=1, world_size=2)
...
if __name__ == "__main__":
    ...
    config = Config(default=r'.\config\train_cord.yaml')
    config.argv_update()
